<div class="modal fade" id="createBahanBarangMasuk" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static">
                    ...
                    <div class="card-body py-0">
                        ...
                        <div class="form-row d-flex justify-content-between">
                            <div class="form-group col-md-4">
                                ...
                                <input type="date" class="form-control" name="tanggal" value="<?= date('Y-m-d'); ?>" autocomplete="off" required>
                            </div>
                        </div>
...
<script type="text/javascript">
    $(function() {
        $('.select2-full').select2({
            dropdownParent: $('#createBahanBarangMasuk'),
            theme: 'bootstrap4',
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.error) {
                    ...
                    $('#createBahanBarangMasuk').modal('hide');
