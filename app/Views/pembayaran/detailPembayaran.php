...
$query = new QueryGa();
?>
<div class="modal fade" id="detail_pembayaran" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="card-body py-0">
                    ...
                    <div class="form-row d-flex justify-content-between">
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" class="form-control text-right" id="grand_total_invoice" value="<?= number_format($grand_total, 0, ',', '.'); ?>" readonly>
                        </div>
                        <div class="form-group col-md-3">
                            ...
                            $total_bayar = 0;
                            foreach ($result as $subvalue) {
                                $detail_po = $query->getTotalBayarInvoice($subvalue['id'])->getRowArray();
                                $total_bayar += $detail_po['total_bayar'];
                            } ?>
                            <input type="text" class="form-control text-right" name="total_bayar" id="total_bayar" value="<?= number_format($total_bayar, 0, ',', '.'); ?>" readonly>
                        </div>
                        <div class="form-group col-md-6">
