                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2-full" name="bahan" id="bahan" data-placeholder="-- Pilih Bahan --" style="width: 100%">
                                ...
                                <?php foreach ($bahan as $value) { ?>
                                    <option value="<?= $value['id']; ?>" data-kode="<?= $value['kode']; ?>" data-bahan="<?= $value['nama']; ?>" <?= ($value['id'] == $row['m_inventori_bahan_lab']) ? 'selected' : ''; ?>><?= $value['alias']; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                        <div class="form-group">
...
<script>
    $(function() {
        ...
        let bahan = $('#bahan').find(':selected').data('bahan');
        let kode = $('#bahan').find(':selected').data('kode');
