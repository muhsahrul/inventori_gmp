<div class="modal fade" id="create_po" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static">
                    ...
                    <div class="card-body py-0">
                        <div class="form-row d-flex justify-content-between">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="nomor" value="<?= $nomor['max_nomor'] + 1 . '/GMP-PO' . '/' . $bulan['kode_romawi'] . '/' . date('Y'); ?>" autocomplete="off">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                        ...
                        <table class="table table-responsive table-bordered" id="table_bahan">
                            ...
                            <tbody id="tbody_bahan">
                                <tr id="row_1">
                                    <td>
                                        <select class="form-control select2-full" name="bahan[]" id="bahan_1" data-placeholder="-- Pilih Bahan --" style="width: 100%;" data-row-id="1" onchange="getDetailBahan(1)">
                                            <option></option>
                                    ...
                                    <td>
                                        <select class="form-control select2-full" name="no_katalog[]" id="no_katalog_1" data-placeholder="-- Pilih No. Katalog --" style="width: 100%;">
                                            <option></option>
                                        </select>
                                    </td>
                        ...
                        <table class="table table-responsive table-borderless">
                            ...
                            <tr>
                                ...
                                <td class="pr-0 pb-0"><input type="text" class="form-control text-right" name="ppn" id="ppn" readonly></td>
                            </tr>
                            <tr>
...
<script type="text/javascript">
    ...
    $("#add_row").unbind('click').bind('click', function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                html += '</select></td>' +
                    '<td><select class="form-control select2-full" name="no_katalog[]" id="no_katalog_' + row_id + '" data-placeholder="-- Pilih No. Katalog --" style="width: 100%;"> <option></option></select></td>' +
    ...
    function getDetailBahan(row_id) {
        ...
        $.ajax({
            url: "po/loadDetailBahan/" + id_bahan,
            dataType: "JSON",
            success: function(data) {
    ...
    $('#btn_submit').click(function() {
        ...
        let data = $('#form_create_po').serialize();
        $.ajax({
            url: "po/savePo",
            data: data,
            type: "POST",
