...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Report Barang Masuk</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Report</a></li>
                        <li class="breadcrumb-item active">Report Barang Masuk</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
...
<script>
    ...
    function loadReportBarangMasuk() {
        let data_filter = $('#form_filter').serialize();
        $.ajax({
            url: "reportBarangMasuk/loadReportBarangMasuk",
            data: data_filter,
