...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Report Parameter</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Report</a></li>
                        <li class="breadcrumb-item active">Report Parameter</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                            ...
                            <form class="form-horizontal" action="" method="POST" id="form_filter">
                                ...
                                <div class="form-row">
                                    <div class="form-group row col-md-8">
                                        <label for="bulan" class="col-sm-2 col-form-label">Parameter</label>
                                        <div class="col-sm-8">
                                            <select class="form-control select2-default" name="parameter" data-placeholder="-- Pilih Parameter --" style="width: 100%;">
                                                <option></option>
...
<script>
    ...
    function loadDataReportParameter() {
        let data_filter = $('#form_filter').serialize();
        $.ajax({
            url: "reportParameter/loadDataReportParameter",
            data: data_filter,
