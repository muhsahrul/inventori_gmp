        ...
        <div class="container-fluid">
                        ...
                        <div class="card-body">
                            <form class="form-horizontal" action="" method="POST" id="form_filter">
                                <div class="form-group row col-md-8 px-0">
                                    <label for="bulan" class="col-sm-2 col-form-label">Tanggal PO</label>
                                    <div class="col-md-4">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-primary card-outline">
                        <div class="card-header d-flex align-items-center">
                            <h3 class="card-title m-0"><?= $subtitle; ?></h3>
                        </div>
...
<script>
    ...
    function loadDataPembelanjaan() {
        let data_filter = $('#form_filter').serialize();
        $.ajax({
            url: "pembelanjaan/loadDataPembelanjaan",
            data: data_filter,
